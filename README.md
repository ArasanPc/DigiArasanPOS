...
If you already have a repo, just copy these files into it, commit, and
push. Otherwise, from inside this `digiarasan-pos` folder:
...
Chrome will create a desktop/home-screen shortcut using the DIGI ARASAN
logo from `manifest.json` / `icons/`, and it'll open in its own app
